    ...
    <section className="my-28">
      ...
      <div className="md:grid md:grid-cols-3 md:gap-10">
        ...
        <div className={serviceContainerStyle}>
          ...
          <p className={positionText_p}>
            {" "}
            Social media are an indispensable tool for any business. I`ll make
            sure they`re updated and optimized.
          </p>
        </div>
        <div className={serviceContainerStyle}>
          <FontAwesomeIcon
        ...
        <div className={serviceContainerStyle}>
          ...
          <p className={positionText_p}>
            On the internet, if you don`t appear on Google, you don`t exist, so
            good practices are required to position your business online.
          </p>
        </div>
      </div>
    </section>

...
function ExperienciaLaboral() {
  return (
    <div className="mx-auto max-w-6xl sm:px-6 lg:px-8 py-10 px-10">
      ...
      <div className="border drop-shadow-sm rounded-lg mb-10">
        <div className="divide-y-2">
          <div className="flex items-center px-6 py-4 text-xl">
            <p className="font-bold">Desarrollo web Front End</p>
          </div>
          <div className="px-6 py-4 text-lg">
            <div className="flex place-items-center">
              <HomeModernIcon className="h-7" />
            ...
            <div className="flex place-items-center mt-2">
              <CalendarDaysIcon className="h-7" />
              <p className="font-semibold pl-2">Octubre 2022 - Actualidad</p>
            </div>
            <p className="mt-2">
      ...
      <div className="hidden md:flex items-center ">
        <div className="flex-col">
          <p className="text-lg  w-9/12 mb-5">
            Tras 6 meses de duro trabajo estudiando desarrollo web por mi cuenta, conseguí mi primer trabajo en el sector.
          </p>
        </div>
        <img
          src="https://github.com/jmontes33/React-Portfolio/blob/main/src/assets/flecha-1.png?raw=true"
      ...
      <div className="border drop-shadow-sm rounded-lg mb-10">
        <div className="divide-y-2">
          ...
          <div className="px-6 py-4 text-lg">
            <div className="flex place-items-center">
              <HomeModernIcon className="h-7" />
              <p className="font-semibold pl-2">Midnova Group, Vigo</p>
            </div>
            <div className="flex place-items-center mt-2">
              <CalendarDaysIcon className="h-7" />
              <p className="font-semibold pl-2">Marzo 2023 - Actualidad</p>
            </div>
            <div>
              <p>Funciones que desarrollo en esta empresa:</p>
              <ui>
                <li>
                  Encargado principal de diseñar y desarrollar la estructura
                  visual de la web.
                </li>
                <li>Análisis de estadísticas mediante Google Analytics.</li>
                <li>
                  Rebranding de la marca personal de la empresa. Diseño en Figma
                  de la nueva web en Wordpress con Divi.
                </li>
              </ui>
            </div>
          </div>
